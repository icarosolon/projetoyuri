...
<DOCTYPE html>
    ...
    <body>
        ...
        <form method="POST" action="atualizaPrato.php" enctype="multipart/form-data">
            ...
            <input class="input-prato" placeholder="Id do Prato" value="<?php $id_prato ?>" disabled/>
            <input class="input-prato" name="nome_do_prato" type="text" placeholder="Nome do prato" maxlenght="40" value="<?php $prato['nome_do_prato'] ?>" />
            <input class="input-prato" name="inf_prato" type="text" placeholder="informações sobre o prato" maxlenght="500" value="<?php $prato['inf_prato'] ?>"/>
